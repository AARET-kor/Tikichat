...
| 4 | Activation wedge: intake parser + quick visit + link + Tiki Desk | implemented | Wedge works; still worth operational hardening and clearer documentation of assumptions. |
...
| 6 | My Tiki / Ask TikiBell | implemented | Safe, source-limited Ask exists. Still relies on hardcoded policy logic and no dedicated FAQ admin surface yet. |
| 7 | Escalation | implemented | Triage, assignment, status, and Tiki Desk tasking exist. SLA/notifications and richer staff workflow are still deferred. |
